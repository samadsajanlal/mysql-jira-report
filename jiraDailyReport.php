...
AND ((issuestatus_0.pname = 'Active_not_Integrated') OR (issuestatus_0.pname = 'Active_Integrated'))
AND ((jiraissue_0.CREATED >= '2014-11-19') AND (jiraissue_0.CREATED <= '2014-11-20'))
) temp1 
-- left outer join
...
if(isset($argv[1]) && isset($argv[2]) && isset($argv[3])){
	...
	$file = "daily_".$argv[1].$fileIdentifierMR.$date.$extensionMR; // sets filename to <Variable1><identifier><YYYYMMDD><extension>
	...
	echo "Execute in format: jiraDailyReport.php CPN GPN LABEL".$lineFeed;
	exit();
}
?>